...
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/default_16 > Results/sjeng/sjengResults_default_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/default_32 > Results/sjeng/sjengResults_default_32
echo "Finished: 3"
zcat traces-long/sjeng.gz | ./main config/default_64 > Results/sjeng/sjengResults_default_64

echo "Starting sjeng: All 2-Way"
zcat traces-long/sjeng.gz | ./main config/all-2way_8 > Results/sjeng/sjengResults_all-2way_8
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/all-2way_16 > Results/sjeng/sjengResults_all-2way_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/all-2way_32 > Results/sjeng/sjengResults_all-2way_32
echo "Finished: 3"
zcat traces-long/sjeng.gz | ./main config/all-2way_64 > Results/sjeng/sjengResults_all-2way_64

echo "Starting sjeng: All 4-Way"
zcat traces-long/sjeng.gz | ./main config/all-4way_8 > Results/sjeng/sjengResults_all-4way_8
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/all-4way_16 > Results/sjeng/sjengResults_all-4way_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/all-4way_32 > Results/sjeng/sjengResults_all-4way_32
echo "Finished: 3"
zcat traces-long/sjeng.gz | ./main config/all-4way_64 > Results/sjeng/sjengResults_all-4way_64

echo "Starting sjeng: L2 4-Way"
zcat traces-long/sjeng.gz | ./main config/l2-4way_8 > Results/sjeng/sjengResults_l2-4way_8
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/l2-4way_16 > Results/sjeng/sjengResults_l2-4way_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/l2-4way_32 > Results/sjeng/sjengResults_l2-4way_32
echo "Finished: 3"
zcat traces-long/sjeng.gz | ./main config/l2-4way_64 > Results/sjeng/sjengResults_l2-4way_64

echo "Starting sjeng: All FA"
zcat traces-long/sjeng.gz | ./main config/all-fa_8 > Results/sjeng/sjengResults_all-fa_8
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/all-fa_16 > Results/sjeng/sjengResults_all-fa_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/all-fa_32 > Results/sjeng/sjengResults_all-fa_32
echo "Finished: 3"
zcat traces-long/sjeng.gz | ./main config/all-fa_64 > Results/sjeng/sjengResults_all-fa_64
...
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/all-fa-l2big_16 > Results/sjeng/sjengResults_all-fa-l2big_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/all-fa-l2big_32 > Results/sjeng/sjengResults_all-fa-l2big_32
echo "Finished: 3"
zcat traces-long/sjeng.gz | ./main config/all-fa-l2big_64 > Results/sjeng/sjengResults_all-fa-l2big_64
...
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/l2-big_16 > Results/sjeng/sjengResults_l2-big_16
echo "Finished: 2"
...
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/l1-2way_16 > Results/sjeng/sjengResults_l1-2way_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/l1-2way_32 > Results/sjeng/sjengResults_l1-2way_32
echo "Finished: 3"
...
echo "Finished: 1"
zcat traces-long/sjeng.gz | ./main config/l1-8way_16 > Results/sjeng/sjengResults_l1-8way_16
echo "Finished: 2"
zcat traces-long/sjeng.gz | ./main config/l1-8way_32 > Results/sjeng/sjengResults_l1-8way_32
echo "Finished: 3"
zcat traces-long/sjeng.gz | ./main config/l1-8way_64 > Results/sjeng/sjengResults_l1-8way_64
